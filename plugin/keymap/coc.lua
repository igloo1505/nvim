...
keyset("n", "<leader>GG", "<Plug>(coc-diagnostic-next)", {silent = true})
...
vim.api.nvim_create_user_command("CocExtensions",":CocList extensions<cr>", {})
...
-- Manage extensions.
keyset("n", "<space>e", ":<C-u>CocList extensions<cr>")
-- Show commands.
keyset("n", "<space>c", ":<C-u>CocList commands<cr>")
